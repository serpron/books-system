...
CREATE TABLE `book`  (
  ...
  `author` int(10) NULL DEFAULT NULL COMMENT '作者',
  `summary` varchar(500) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '简介',
  `chapter_count` int(10) NULL DEFAULT NULL COMMENT '章节数目',
  `process_state` int(255) NULL DEFAULT NULL COMMENT '连载状态1=连载中，2=完本',
  `state` int(255) NULL DEFAULT NULL COMMENT '书籍状态1=新键，2=审批通过，3=下架',
  `points` int(10) NULL DEFAULT NULL COMMENT '每千字点数',
  `score` float(255, 0) NULL DEFAULT NULL COMMENT '评分',
  `replies` int(10) NULL DEFAULT NULL COMMENT '回复数',
  `current_chapter` int(255) NULL DEFAULT NULL COMMENT '当前章节',
  `publish_date` datetime(0) NULL DEFAULT NULL COMMENT '发布时间',
  `cover_pic` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '封面',
...
-- Records of book
-- ----------------------------
INSERT INTO `book` VALUES (1, '大胆妖参放开我', 1, '叶灵穿越成了一根人参，手里拥有能让妖怪变强的机缘，妖怪越强他获得的好处就越多。\r\n于是他开始大力收妖怪：树娘，狐娘，鹿娘，蛇娘，草娘，花娘，鱼娘，蜂娘……\r\n这些妖怪也没有让他失望，教什么会什么，看什么悟什么，所以，他的实力开始变得越来越强。\r\n血脉晋级，变成一根芳香四溢身形饱满的人参。\r\n血脉晋级，变成一根美味可口鲜嫩多汁的人参。\r\n血脉晋级，变成一根灵气充盈包治百病的人参……\r\n……\r\n但渐渐的，叶灵发现了一个问题，他变得越强，身上的味道就越香，妖怪们对他就越难克制。\r\n看着周围越来越多流着口水的妖怪，他不禁陷入沉思：“怎么办，我还要不要继续变强？在线等，挺急的！”\r\nPS：本书轻松欢乐向，不虐主，仅向未来穿越者科普一个理念：“不同妖怪玩法不同，一定要找准突破口！”', 18, 2, 2, 0, 100, 0, 12, '2018-10-01 00:00:00', NULL, 1);
INSERT INTO `book` VALUES (2, '明朝那些事1', 2, NULL, 31, 3, 2, NULL, 100, NULL, 31, '2020-11-04 16:28:45', NULL, NULL);
...
CREATE TABLE `category`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '分类名字',
  `order_num` int(11) NULL DEFAULT NULL COMMENT '排序编号',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES (1, '玄幻', 1);
INSERT INTO `category` VALUES (2, '奇幻', 2);
INSERT INTO `category` VALUES (3, '武侠', 3);
INSERT INTO `category` VALUES (4, '历史', 4);
INSERT INTO `category` VALUES (5, '军事', 5);
INSERT INTO `category` VALUES (6, '评书', 6);
INSERT INTO `category` VALUES (7, '军事', 7);
INSERT INTO `category` VALUES (8, '历史', 8);
INSERT INTO `category` VALUES (9, '游戏', 9);
INSERT INTO `category` VALUES (10, '体育', 10);
INSERT INTO `category` VALUES (11, '科幻', 11);
INSERT INTO `category` VALUES (12, '悬疑', 12);
...
CREATE TABLE `chapter`  (
  ...
  `chapter_id` int(10) NULL DEFAULT NULL COMMENT '章节编号',
  `content` text CHARACTER SET utf8 COLLATE utf8_bin NULL COMMENT '章节内容',
  `words` int(255) NULL DEFAULT NULL COMMENT '章节字数',
  `publish_date` datetime(0) NULL DEFAULT NULL COMMENT '发布时间',
  `book_id` int(11) NULL DEFAULT NULL COMMENT '书籍编号',
  `read_count` int(255) NULL DEFAULT NULL COMMENT '阅读数',
  `reply_count` int(255) NULL DEFAULT NULL COMMENT '评论数',
  `pay_state` int(255) NULL DEFAULT NULL COMMENT '1=收费，2=免费',
...
CREATE TABLE `exchange_record`  (
  ...
  `exchange_type_id` int(11) NULL DEFAULT NULL COMMENT '兑换标砖',
  `exchange_date` datetime(0) NULL DEFAULT NULL COMMENT '兑换时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;

-- ----------------------------
-- Table structure for exchange_type
-- ----------------------------
DROP TABLE IF EXISTS `exchange_type`;
CREATE TABLE `exchange_type`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `money` int(255) NULL DEFAULT NULL COMMENT '人民币',
  `points` int(255) NULL DEFAULT NULL COMMENT '点数',
  `state` int(11) NULL DEFAULT NULL COMMENT '状态1=启用，2=停用',
  `publish_date` datetime(0) NULL DEFAULT NULL COMMENT '发布时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;

-- ----------------------------
-- Records of exchange_type
-- ----------------------------
INSERT INTO `exchange_type` VALUES (1, 1, 100, 1, '2020-11-04 16:18:03');
INSERT INTO `exchange_type` VALUES (2, 100, 11000, 1, '2020-11-04 16:18:25');
INSERT INTO `exchange_type` VALUES (3, 1000, 150000, 1, '2020-11-04 16:18:37');
INSERT INTO `exchange_type` VALUES (4, 10000, 1800000, 1, '2020-11-04 16:18:56');
...
CREATE TABLE `payment`  (
  ...
  `period` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付周期',
  `money` int(255) NULL DEFAULT NULL COMMENT '支付金额',
  `state` int(11) NULL DEFAULT NULL COMMENT '支付状态1=申请，2=审批，3=已支付，4=取消',
  `approve_id` int(11) NULL DEFAULT NULL COMMENT '审批人id',
...
CREATE TABLE `record`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `book_id` int(11) NULL DEFAULT NULL COMMENT '书籍编号',
  `chapter_id` int(11) NULL DEFAULT NULL COMMENT '章节编号',
  `words` int(255) NULL DEFAULT NULL COMMENT '字数',
  `read_date` datetime(0) NULL DEFAULT NULL COMMENT '阅读时间',
  `user_id` int(11) NULL DEFAULT NULL COMMENT '阅读人',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;
...
CREATE TABLE `reply`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `book_id` int(255) NULL DEFAULT NULL COMMENT '书籍编号',
  `content` varchar(2000) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '评论内容',
  `star` int(255) NULL DEFAULT NULL COMMENT '星级',
  `publish_date` datetime(0) NULL DEFAULT NULL COMMENT '发表时间',
  `parent_id` int(11) NULL DEFAULT NULL COMMENT '上级评论',
  `level` int(11) NULL DEFAULT NULL COMMENT '评论层次',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;
...
-- Records of role
-- ----------------------------
INSERT INTO `role` VALUES (1, '读者');
INSERT INTO `role` VALUES (2, '作者');
INSERT INTO `role` VALUES (3, '审核');
INSERT INTO `role` VALUES (4, '财务');
INSERT INTO `role` VALUES (5, '总经理');
INSERT INTO `role` VALUES (6, '管理员');
...
CREATE TABLE `user`  (
  ...
  `phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '电话',
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '邮箱',
  `state` int(255) NOT NULL DEFAULT 1 COMMENT '状态,1=注册，2=激活，3=注销，0=内置',
  `weixin` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '微信号',
  `qq` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT 'qq号',
  `uuid` varchar(20) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '用户的系统编号',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '张三', 1, '123456789', 'zhangsan@163.com', 1, NULL, NULL, 'dz100001', '123');
INSERT INTO `user` VALUES (2, '李四', 1, '123456789', 'lisi@163.com', 1, NULL, NULL, 'dz100002', '123');
INSERT INTO `user` VALUES (3, '王五', 2, '123456788', 'wangwu@163.com', 1, NULL, NULL, 'zz100001', '123');
INSERT INTO `user` VALUES (4, '当年明月', 2, '123456789', 'zhaoliu@111.com', 1, NULL, NULL, 'zz100002', '123');
INSERT INTO `user` VALUES (5, '唐僧', 3, '123456789', 'tangseng@111.com', 1, NULL, NULL, 'sh100001', '123');
INSERT INTO `user` VALUES (6, '财务1', 4, '123456789', 'caiwu@11.com', 1, NULL, NULL, 'cw100001', '123');
INSERT INTO `user` VALUES (7, 'CEO', 5, '123456789', 'ceo@163.com', 1, NULL, NULL, 'ceo100001', '123');
INSERT INTO `user` VALUES (8, '管理员', 6, '123456789', 'admin@11.com', 1, NULL, NULL, 'admin100001', '123');
...
CREATE TABLE `writer_info`  (
  ...
  `bank_card` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '银行卡号',
  `bank_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '银行名称',
  `alipay` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '支付宝',
  `weixin` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '微信号',
  `pen_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '笔名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Compact;
...
-- ----------------------------
INSERT INTO `writer_info` VALUES (1, 3, '王五', '1111111111', '洛阳', '1111111111', '中国银行', '1111111', '2222222', '王大五');
INSERT INTO `writer_info` VALUES (2, 4, '李四', '1111111111', '郑州', '2222222222', '工商银行', '22222222', '222222222', '李大四');
